...
load TV1abcd.mat
data=trainvec;
% Get the first 8 columns of the data
selectedData = data(:, 1:8);

% Create a new figure with larger size
figure('Position', [100, 100, 1000, 800]);

% Loop through each channel and create subplots
for i = 1:8
    subplot(8, 1, i);
...
suptitle('Eight Channel sEMG Data from Myo Armband');
